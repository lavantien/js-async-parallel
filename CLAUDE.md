...
1. Latest Documentation: Use Context7 MCP to get up-to-date library docs
    - First: Use mcp**plugin_context7_context7**resolve-library-id to find the library
    - Then: Use mcp**plugin_context7_context7**query-docs to get specific info

2. Web Search: Use mcp**web-search-prime**webSearchPrime for:
    - Latest library versions and syntax
    - Breaking changes in recent releases
    - Current best practices (patterns change over time)

3. Web Reader: Use mcp**web_reader**webReader for:
    - Reading official documentation pages
    - Checking GitHub repositories for examples
    - Fetching specific documentation URLs

4. ZRead: Use mcp**zread**\* tools for:
